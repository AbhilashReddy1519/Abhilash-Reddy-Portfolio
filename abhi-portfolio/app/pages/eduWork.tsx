    ...
    <>
        <section className={styles.education}>
            ...
            <div className={styles.exp}>
                ...
                <div>
                <h1>
                    Software Engineer | Full stack & Data Engineering | Focused on
                    System Design & Scalable Architecture Enthusiast
                </h1>
                </div>
                <a
                href="https://drive.google.com/file/d/1RL_b3J3zAua8sW-FwBvIeMBVcuFmEZww/view?usp=sharing"
                target="_blank"
                rel="noopener"
                >
                Download resume
            ...
            <div className={styles.expJustify}>
                ...
                <div aria-label="description">
                    <p>
                    Built and deployed responsive web features using MongoDB,
                    Express.js, React, and Node.js; designed efficient database
                    schemas, integrated REST APIs, and implemented
                    authentication. Collaborated in agile sprints with
                    Git/GitHub, improving scalability and end-to-end application
                    performance.
                    </p>
                </div>
                </div>
